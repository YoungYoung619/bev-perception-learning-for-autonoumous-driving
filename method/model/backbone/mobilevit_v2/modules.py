...
from .config import make_divisible
from .layers import ConvLayer, get_normalization_layer, get_activation_fn, Dropout, LinearSelfAttention
...
class MobileViTBlockv2(BaseModule):
    ...
    def __init__(
        ...
        self.enable_coreml_compatible_fn = getattr(
            opts, "common.enable_coreml_compatible_module", True
        )
