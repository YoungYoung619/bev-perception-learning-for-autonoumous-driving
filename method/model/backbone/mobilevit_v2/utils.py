...
def initialize_weights(opts, modules) -> None:
    ...
    conv_init_type = opts['layer']['conv_init'] if 'conv_init' in opts else "kaiming_normal"
    linear_init_type = opts['layer']['linear_init'] if 'linear_init' in opts else "normal"

    conv_std = opts['layer']['conv_init_std_dev'] if 'conv_init_std_dev' in opts else None
    linear_std = opts['layer']['linear_init_std_dev'] if 'linear_init_std_dev' in opts else 0.01
    group_linear_std = opts['layer']['group_linear_init_std_dev'] if 'group_linear_init_std_dev' in opts else 0.01
